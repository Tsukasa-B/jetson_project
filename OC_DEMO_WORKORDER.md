...
> **本ドキュメントは初期設計時点(2026-07-30)の指示書です。現在の運用・トラブル対応は
> [`oc_demo/README.md`](oc_demo/README.md) を正としてください。** 「結線点3つ」
> （§3）はいずれも`oc_demo/README.md`作成時点までに解消・置き換え済みです
> （詳細は同READMEの末尾「`OC_DEMO_WORKORDER.md`との関係」章を参照）。
